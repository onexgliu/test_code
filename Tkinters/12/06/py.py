...
canvas.create_arc(5, -70, 185, 162, extent=-40, outline="#32E143", fill="#32E143", start=-70, width=2,
                  style=PIESLICE)  # 西瓜的皮
canvas.create_arc(8, -67, 181, 155, extent=-40, outline="#E92742", fill="#E92742", start=-70, width=2,
                  style=PIESLICE)  # 西瓜的瓤
